...
public:
	...
	void unionn(char Name1, char Name2, char newName);
	
	void intersection(char Name1, char Name2, char newName);
	
	void difference(char Name1, char Name2, char newName);
	
	void difference_sim(char Name1, char Name2, char newName);
	void dekartovo_multiply(char Name1, char Name2, char newName);
...
private:
	...
	void dekartovo_multiply(int Name1, int Name2);
